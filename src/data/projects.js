...
export const projects = [
  { slug: 'robert-geller',      num: '01', short: 'Robert Geller',      caption: 'Robert Geller', client: 'Lululemon', title: 'Robert Geller', dir: '/images/robert-geller',      count: 3, width: 48, subtitle: rgSub, desc: rgDesc, heroImages: [`/images/robert-geller/hero-1.jpg`, `/images/robert-geller/hero-2.jpg`, `/images/robert-geller/hero-3.jpg`, `/images/robert-geller/hero-4.jpg`], process: rgProcess },
  { slug: 'suminagashi',        num: '02', short: 'Suminagashi',        caption: 'Suminagashi',   client: 'Lululemon Lab', title: 'Suminagashi', dir: '/images/suminagashi',        count: 13, width: 44, subtitle: sumiSub, desc: sumiDesc },
  { slug: 'seawheeze',          num: '03', short: 'Seawheeze',          caption: 'Seawheeze',     client: 'Lululemon', title: 'Seawheeze', dir: '/images/seawheeze',          count: 8,  width: 38, subtitle: seaSub, desc: seaDesc },
  { slug: 'year-of-the-rabbit', num: '04', short: 'Year of the Rabbit', caption: 'Year of the Rabbit', client: 'Lululemon', title: 'Year of the Rabbit', dir: '/images/year-of-the-rabbit', count: 9,  width: 47, subtitle: lnySub, desc: lnyDesc },
  { slug: 'zebra-print',        num: '05', short: 'Zebra Print',        caption: 'Zebra Print',        client: 'CUUP',      title: 'Zebra Print',           dir: '/images/zebra-print',        count: 6,  width: 42, subtitle: cuupSub, desc: cuupDesc },
];
